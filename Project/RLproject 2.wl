...
generator := Function[(
	...
	If[And[Mod[#AbsoluteBatch,400]==0,random <= 2],(random = random + 1;
	processed = preprocess[randomgame[30,200]]),I
	f[Mod[#AbsoluteBatch,400]==0 ,(processed = preprocess[game[10,200,#Net]]),0];];
